...
if(isset($_POST['addnewrecord']))
{
    ...
    if($validate->validate() && count($stat) == 0)
    {
				...
				$iLastId=$db->getVal("select id from fee_sturcture order by id desc")+1;		
	...
	$validate->addRule($_POST['title'],'','Title',true);
     if($validate->validate() && count($stat) == 0)
		...
		$aryData = array(
			...
			$flgIn2 = $db->updateAry("fee_sturcture", $aryData, "where randomid='".$_GET['randomid']."'");
          ...
          <div class="col-md-12"> 
            ...
            <div class="card">
              <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="<?php if($_GET['action']=='' || $_GET['action']=='manage_trait') { echo "active"; } ?>"> 
                <a href="<?php echo $Filename; ?>?action=manage_trait"> <i class="fa fa-exclamation-circle" aria-hidden="true"></i> <span>Fee Structure</span> </a> </li>
              </ul>
                      ...
                      <div class="col-md-12 col-xs-12">
                          ...
                          <div class="card-box table-responsive tablthisresponsive">
                            <table class="table table-striped table-bordered">
                              ...
                              <tbody>
                                <?php $i=0;
				$NewcrearyLisCredtet=$db->getRows("select * from fee_sturcture where create_by_userid='".$create_by_userid."' and status !=2 order by id desc");
                              ...
                              <form action="" method="POST">
                                <tr>
                                  <td><?php echo $i ?></td>
                                   ...
                                   <input type="text" name="title" value="<?php echo $iList['title']; ?>" class="form-control">
                                    <?php } else { echo $iList['title']; } ?></td>
